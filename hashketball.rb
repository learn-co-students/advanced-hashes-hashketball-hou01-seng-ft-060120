...
def player_stats(player_name)
  # Loop over the game hash
  game_hash.each_pair do |key, value|
    value.each_pair do |ckey, cvalue|
      # Check if the current key is at :players
      if ckey == :players
        # Loop over the player object
        cvalue.each do |player_object|
          # Check if the name is the same
          if player_object[:player_name] == player_name
            return player_object # This should give you the stats of the player
          end
        end
      end
    end
